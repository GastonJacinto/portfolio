        ...
        <ul className="flex w-[22rem] flex-wrap items-center justify-center gap-y-1 text-[0.9rem] font-medium text-gray-500 sm:w-[40rem] sm:flex-nowrap sm:gap-5">
          {header.map((link) => (
            ...
            >
              <Link
                className={clsx(
                  'flex w-full items-center justify-around px-3 py-3 hover:text-gray-950 transition dark:text-gray-500 dark:hover:text-gray-300',
